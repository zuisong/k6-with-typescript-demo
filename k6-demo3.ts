...
export function main() { //Test Case 1
  ...
  const checkRes = check(res, {
    ...
    "response body contains <OWASP Juice Shop>": (r) =>
      r.body.indexOf("OWASP Juice Shop") !== -1,
...
export function login() { //Test Case 2
  ...
  const checkRes = check(res, {
    ...
    "response body contains <OWASP Juice Shop> in the Login page": (r) =>
      r.body.indexOf("OWASP Juice Shop") !== -1,
...
export function about() { //Test Case 3
  ...
  const checkRes = check(res, {
    ...
    "response body contains <OWASP Juice Shop> in the About page": (r) =>
      r.body.indexOf("OWASP Juice Shop") !== -1,
